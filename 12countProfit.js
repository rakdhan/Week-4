function countProfit(shoppers) {
    // kalo amount lebih banyak dari stock, gak akan dibeli sama cekalee
    ...
    for (let j = 0; j < listBarang.length; j++) {
        ...
        for (let i = 0; i < shoppers.length; i++) {
            if (shoppers[i].product === listBarang[j][0] && (obj.leftOver - shoppers[i].amount) >= 0) {
